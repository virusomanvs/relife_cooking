## Обновился конфиг. Используйте конвертер чтобы преобразовать свой конфиг в новый формат. Для этого откройте https://virusomanvs.github.io/cook и вставьте туда массив из ваших рецептов. НЕ КОНФИГ ЦЕЛИКОМ! Только рецепты! Вместе с квадратными скобками.
